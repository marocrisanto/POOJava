...
package ejercicio13main;

import ejercicio13vectores.Curso;
import ejercicio13vectores.CursoService;
...
public class CursoMain {
    public static void main(String[] args){
        ...
        //Instanciamos la clase CursoService para crear un servicio
        CursoService service = new CursoService();
        
        // Utilizamos el método crearCurso de la instancia cursoServices para solicitar al usuario
        // que ingrese los datos del curso y almacenar estos datos en la instancia curso
        service.crearCurso(curso);
        
        // Utilizamos el método mostrarCurso de la instancia cursoServices para imprimir los detalles del curso
        // incluyendo la ganancia semanal
        service.mostrarCurso(curso);
    }
}
