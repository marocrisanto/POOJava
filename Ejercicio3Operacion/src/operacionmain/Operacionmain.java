...
package operacionmain;

import ejercicio3operacion.Operacion;
import ejercicio3operacion.OperacionService;
...
public class Operacionmain {
    ...
    public static void main(String[] args) {
        ...
        Operacion mostrarOperacion = new Operacion();//Creamos un objeto vacio
        OperacionService servicio = new OperacionService();//Creamos un servicio
        
        //Cargamos el objeto con el servicio y lo imprimimos
        mostrarOperacion = servicio.crearOperacion();
        servicio.mostrarSuma(mostrarOperacion);
        servicio.mostrarResta(mostrarOperacion);
        servicio.mostrarMultiplicacion(mostrarOperacion);
        servicio.mostrarDivision(mostrarOperacion);
    }
}
