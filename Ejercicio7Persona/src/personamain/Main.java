...
import persona.PersonaServices;
/*
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Instanciamos la clase PersonaServices
        PersonaServices servicio = new PersonaServices();//Creamos un servicio
        
        //Creamos 4 personas 
        Persona[] listaPersonas = new Persona[servicio.getNumeroPersonas()];
        
        //Llenamos las personas usando el servicio
        listaPersonas = servicio.crearPersona();
       
        //Invocamos el metodo calcularEImprimirIMC del objeto servicio y le damos los objetos Persona a imprimir
        servicio.calcularEImprimirIMC(listaPersonas);
    }
}
